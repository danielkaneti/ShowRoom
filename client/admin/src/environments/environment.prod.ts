export const environment = {
  ...
  showroomUrl: 'http://localhost:2222',
  usersUrl: 'http://localhost:2222/Users',
  productsUrl: 'http://localhost:2222/Products',
  reviewsUrl: 'http://localhost:2222/Reviews',
  reviewUrl2:'http://localhost:2222/reviews/getReviewsProductsUsers',
  countProductsUrl: 'http://localhost:2222/products/countProducts',
  ...
  productSearch: 'http://localhost:2222/products/getProductByParams',
