    ...
    return (
        ...
        <header className="w3-display-container w3-wide" id="home">
          ...
          <div className="w3-display-left w3-padding-large">
            <h6><button className="w3-button w3-black w3-padding-large w3-large w3-hover-opacity-off" Link to="/women">SHOP WOMEN</button></h6>
          </div>
          <div className="w3-display-right w3-padding-large">
            <h6><button className="w3-button w3-black w3-padding-large w3-large w3-hover-opacity-off">SHOP MAN</button></h6>
          </div>
        </header>
      </div>
