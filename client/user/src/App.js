...
and is wrapped around the whole page content, except for the footer in this example */}
        <div className="w3-content" style={{maxWidth: '1600px'}}>
          ...
          <header className="w3-display-container w3-wide" id="home">
            <img className="w3-image" src="https://www.w3schools.com/w3images/jane.jpg" alt="Fashion Blog" width={1600} height={1060} />
          ...
          <div className="w3-row w3-padding w3-border">
            ...
            <div className="w3-col l8 s12">
              ...
              <div className="w3-container w3-white w3-margin w3-padding-large">
                <div className="w3-center">
                  <h3>TITLE HEADING</h3>
                  <h5>Title description, <span className="w3-opacity">April 23, 2016</span></h5>
                </div>
                <div className="w3-justify">
                  ...
                  <div id="demo2" style={{display: 'none'}}>
                    ...
                    <div className="w3-row w3-margin-bottom">
                      ...
                      <div className="w3-col l10 m9">
                        <h4>Angie <span className="w3-opacity w3-medium">April 23, 2015, 9:12 PM</span></h4>
                        <p>Love hats!!</p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="w3-container w3-white w3-margin w3-padding-large">
                <div className="w3-center">
                  <h3>TITLE HEADING</h3>
                  <h5>Title description, <span className="w3-opacity">April 7, 2016</span></h5>
                </div>
                <div className="w3-justify">
                  <img src="https://www.w3schools.com/w3images/runway.jpg" alt="Runway" style={{width: '100%'}} className="w3-padding-16" />
            ...
            <div className="w3-col l4">
              ...
              <div className="w3-white w3-margin">
                ...
                <ul className="w3-ul w3-hoverable w3-white">
                  <li className="w3-padding-16">
                    <img src="https://www.w3schools.com/w3images/avatar_smoke.jpg" alt="Image" className="w3-left w3-margin-right" style={{width: '50px'}} />
                    <span className="w3-large">Denim</span>
                    <br />
                    <span>Sed mattis nunc</span>
                  </li>
                  <li className="w3-padding-16">
                    <img src="https://www.w3schools.com/w3images/bandmember.jpg" alt="Image" className="w3-left w3-margin-right" style={{width: '50px'}} />
                  ...
                  <li className="w3-padding-16">
                    <img src="https://www.w3schools.com/w3images/avatar_smoke.jpg" alt="Image" className="w3-left w3-margin-right w3-sepia" style={{width: '50px'}} />
              ...
              <div className="w3-white w3-margin">
                ...
                <div className="w3-row-padding w3-white">
                  ...
                  <div className="w3-col s6">
                    <p><img src="https://www.w3schools.com/w3images/avatar_hat.jpg" alt="Men in Hats" style={{width: '100%'}} className="w3-grayscale" /></p>
